/* ============================================================
   ...
   Connects to MongoDB via Express server at http://localhost:3000
   ============================================================ */
...
function saveAndRedirect(data) {
  ...
  localStorage.setItem("rps_user",     JSON.stringify(data.user));
  sessionStorage.setItem("rps_session", JSON.stringify({ username: data.user.username, name: data.user.name }));
